...
<div class="flex flex-col justify-between min-h-screen">
	<div
		class=" bg-gradient-to-tr from-green-500 to-orange-300 w-full h-auto"
	>
		<div class="flex flex-wrap items-center justify-between md:mx-4 lg:mx-32 p-4">
			<a
				href="/"
	...
	<div class="bg-gradient-to-br from-[#D9A84E] via-[#967B3E] to-[#5A4A2E]">
		{#key data.url}
			...
			>
				<div class="slot-content flex-grow" style="width: 100%; height: 100%;">
					{@render children()}
				</div>
			</div>
		{/key}
	...
	>
		<div class="flex flex-wrap items-center justify-center md:mx-4 lg:mx-32 py-4">
			<a
				href="/"
				class="flex items-center justify-center gap-8 hover:scale-110 transform transition duration-500"
			>
				<span class="self-center font-semibold whitespace-nowrap"> © Oliver Stalder & Olivier Vroege 2024 </span>
			</a>
		</div>
	</div>
</div>
