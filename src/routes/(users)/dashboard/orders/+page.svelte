...
<div class="h-[calc(100vh-10rem)] gap-4 overflow-auto p-4 rounded-md">
    <section id="orders" class="bg-white text-[#0f172a] p-20 rounded-b-md">
        <div class="container mx-auto text-center">
            ...
            <p class="mb-4">Wenn Sie eine Bestellung stornieren möchten, nutzen Sie bitte die <a href="/contact" class="text-blue-500 underline">Kontaktseite</a>.</p>
            <div class="grid grid-cols-1 gap-8">
                {#each orders as order}
                    <div class="p-4 border rounded-md">
                        ...
                        <p><strong>Lieblingstiere:</strong> {order.favouriteAnimals}</p>
